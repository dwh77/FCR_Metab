...
results3 <- left_join(results2, results_100day, by = "corrected_Year") %>%  mutate_if(is.numeric, round, digits=2)
...
k201921long <- k201921 %>%  pivot_longer(-9)
kruskal <- kruskal.test(value ~ name, data = k201921long)
kruskal

levels <- c("NEP", "NEP_one", "NEP_five", "NEP_ten", "NEP_twenty", "NEP_forty", "NEP_eighty", "NEP_hundred")
