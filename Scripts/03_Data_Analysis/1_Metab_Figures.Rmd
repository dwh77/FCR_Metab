...
#make figure that just groups all data into seasons for sup fig 6
...
SupFig_S6 <- gpp_acrossseasons_kruskal / r_acrossseasons_kruskal / nep_acrossseasons_kruskal

ggsave(filename = "../../Figures/SupFig_SX_metab_acrossseasons.png",
       SupFig_S6, device = "png", width = 350, height = 200, units = "mm")
...
wilcox.test(NEP ~ icevector, data = b) #can add paired if same lenght

t.test(NEP~icevector, data = b)
