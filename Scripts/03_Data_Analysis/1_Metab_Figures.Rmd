...
# ggsave(filename = "../../Figures/Fig_S4_SeasonsTestsFig2.jpg",
...
### adding just winter to the figure 
 level_fig2 <- c("All Seasons", "No Winter", "Winter Only")
...
fig2_winterVSnowinter_vsjustwinter <- fig2_data_operational %>% 
  ...
  geom_boxplot()+
  geom_jitter(aes(color = as.factor(corrected_Year)), size = 4, position=position_jitter(0))+
    stat_compare_means(method = "kruskal.test", label.y = -0.35, label.x = 1.3, size = 6)+
  labs(x = element_blank(), y = nep_label,
       color = element_blank())+
...
# ggsave(filename = "../../Figures/MS_drafts/GPP_R_full_timeseries_NEP7day.jpg",       
#        full_ts, device = "jpg", width = 230, height = 150, units = "mm")
...
# fig2
# 
# # ggsave(filename = "../../Figures/MS_drafts/Fig2_median.jpg",
# #        fig2, device = "jpg", width = 350, height = 200, units = "mm")
...
# ggsave(filename = "../../Figures/SupFig_S5_metab_acrossyears.jpg",
...
# 
# ggsave(filename = "../../Figures/SupFig_SX_metab_acrossseasons.jpg",
#        SupFig_SX_acrossseasons, device = "jpg", width = 350, height = 200, units = "mm")
...
metab2016 <- metab_seasons %>% 
  ...
  theme_bw(base_size = 22)+
   theme(panel.border = element_rect(color = "black", size =1),
        ...
        panel.background = element_rect(fill = "skyblue2"),
        panel.grid.major = element_blank(),
        #axis.title.y = element_text(hjust = -0.00000000000001),
                panel.grid.minor = element_blank()
        ) +
  ggtitle("2016 Winter")
...
ggsave(filename = "../../Figures/Fig3_Fin.jpg",
...
# ggsave(filename = "../../Figures/FigS6_WinterComp_byyears.jpg",
...
wintercomp_acrossyears <- winterNEP %>% 
  ...
  geom_boxplot(position = position_dodge(preserve = "single"), alpha = 1, outlier.alpha = 0.5)+   #, outlier.alpha = 0
  ...
  stat_compare_means(method = "wilcox.test", label.y = -1.5, label.x = 1, size = 6, aes(label = sprintf("Wilcoxon, p = %5.2f", as.numeric(..p.format..))))+ #round to 2 digits
  ylim(-1.5, 0.5)+
  labs(fill = element_blank(),
       shape = "Year",
       x = element_blank(),
...
# ggsave(filename = "../../Figures/SupFigX_SeasonsComp_byyear.jpg",
#        seasonscomp_byyear_SuppFig, device = "jpg", width = 350, height = 200, units = "mm")
...
NEPseasonscomp_acrossyears <- boxdata_grouped %>% 
  ...
  #stat_compare_means(method = "kruskal.test", label.y = 0.45, label.x = 1.3, size = 6)+
      stat_compare_means(method = "kruskal.test", label.y = -1.7, label.x = 1.3, size = 6, aes(label = sprintf("Kruskal-Wallis, p = %5.2f", as.numeric(..p.format..))))+ #round to 2 digits
  ylim(-1.7, 0.5)+
  labs(fill = element_blank(),
       shape = "Year",
       x = element_blank(),
...
```{r}
 ...
 fig4top <- wintercomp_byyear_NEP + wintercomp_acrossyears + plot_layout(widths = c(7,3)) # can't figure out height curretnly plot_layout(heights = c(0.25, 0.5)) 
...
ggsave(filename = "../../Figures/Fig4_test.jpg",
       fig4, device = "jpg", width = 350, height = 200, units = "mm")
...
ggsave(filename = "../../Figures/FigS7_DOunderIce.jpg",
       DOprofile_underice, device = "jpg", width = 200, height = 250, units = "mm")
