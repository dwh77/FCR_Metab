...
full_ts <- ggplot(data = metab_seasons, aes(x = Date, y = GPP_QAQC))+
  ...
  geom_point(aes(x=Date,y=(R_QAQC*-1)),shape = 21, color = "black", fill ="brown",size=4, alpha = 0.5)+ 
...
## Fig 4a,b, Fig S6; Winter NEP boxplots 
...
## Fig S7; 9m DO under ice and temp profiles 
...
ggsave(filename = "../../Figures/Fig_S7_DOunderIce.jpg",
