...
# ggsave("../../Figures/WinterTS_fig3.png", width = 800, height = 500, units = "mm")
...
icecover_dotplots_B <-  binded_icedata_remove_zeros %>% 
  ...
  scale_x_date(breaks = seq(min(ymd("2023-12-20")), max(ymd("2024-02-22")), by = "21 days") , date_labels = "%d %b", expand = c(0,0))+
